...
describe("getThreadId", () => {
  beforeEach(() => {
    sessionStorage.setItem("@indykite/thid", "98765");
  });
...
describe("setThreadId", () => {
  ...
  it("sets correct value", () => {
    expect(sessionStorage.getItem("@indykite/thid")).toBe("112233");
  });
});

describe("getFPThreadId", () => {
  beforeEach(() => {
    sessionStorage.setItem("@indykite/forgot-password-thid", "98765");
  });
...
describe("setFPThreadId", () => {
  ...
  it("sets correct value", () => {
    expect(sessionStorage.getItem("@indykite/forgot-password-thid")).toBe("998877");
  });
});
