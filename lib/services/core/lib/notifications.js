 ...
 */
const cleanAllNotifications = () => localStorage.removeItem(notificationStatePath);
 ...
 * @param text
 * @param {Parameters<typeof notificationUI>[1]} type
 * @returns {string|null}
 */
...
const handleError = (err) => {
  if (window.IKSDK && window.IKSDK.config && window.IKSDK.config.onError) {
