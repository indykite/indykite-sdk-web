...
const getBaseAuthUrl = () => {
  return `${getBaseUri()}/auth/${getJarvisVersion()}/${getApplicationId()}`;
};
...
const getElementIds = () => ({
  ...
  submitBtn: "IKUISDK-btn-submit",
  btnPrefix: "IKUISDK-btn",
  inputPrefix: "IKUISDK-input",
  formPrefix: "IKUISDK-form",
});
