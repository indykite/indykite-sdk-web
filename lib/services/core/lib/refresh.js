...
/**
 * New access token is automatically saved to the storage.
 *
 * @param {string} refreshToken
 * @param {string} cc
 * @param {boolean} [omitAuthorizationHeaders]
 * @returns {Promise<string | object>}
 */
const refreshAccessToken = async (refreshToken, cc, omitAuthorizationHeaders) => {
