...
beforeEach(() => {
  ...
  props = {
    ...
    onSuccess: jest.fn(),
    onBeforeRender: jest.fn().mockImplementation((form) => form),
    ...
    describe("when renderElementSelector is present in props", () => {
      ...
      describe("when an element matching the selector exists", () => {
        ...
        describe("when deprecated props are not present", () => {
          ...
          it("calls onBeforeRender with correct arguments", () => {
            expect(props.onBeforeRender).toBeCalledTimes(1);
            expect(props.onBeforeRender.mock.calls[0][0].className).toBe("mocked-wrapper");
          });
        ...
        describe("when deprecated props are present", () => {
          ...
          beforeEach(() => {
            ...
            props.onBeforeRender = jest.fn().mockImplementation(() => {
              customEl = document.createElement("div");
              customEl.className = "custom-mocked-wrapper";
              return customEl;
            });
