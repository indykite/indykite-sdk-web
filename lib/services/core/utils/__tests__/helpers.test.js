...
describe("sendRequest", () => {
  describe("when no data and config are specified", () => {
    ...
    it("sends correct request", () => {
      ...
      expect(nodeFetch.mock.calls[0]).toEqual([
        "www.example.net",
        {
          headers: {
  ...
  describe("when POST method with data object is passed", () => {
    beforeEach(() => {
      sendRequest("www.example.net", "POST", { value: 42 });
    });
...
describe("createIdFromString", () => {
  it("returns correct id", () => {
    ...
    expect(createIdFromString("vipps.no")).toBe("vipps");
    expect(createIdFromString("bankid.no")).toBe("bankid");
...
describe("createProviderName", () => {
  it("returns correct id", () => {
    ...
    expect(createProviderName("vipps.no")).toBe("Vipps");
    expect(createProviderName("bankid.no")).toBe("BankID");
